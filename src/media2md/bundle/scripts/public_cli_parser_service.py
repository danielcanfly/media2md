...
def add_common_top_level_commands(
    ...
    *,
    ...
    setcmd.add_argument("--bilibili-caption-first", action=argparse.BooleanOptionalAction)
    setcmd.add_argument("--bilibili-long-video-threshold-minutes", type=float)
    setcmd.add_argument("--bilibili-chunk-minutes", type=float)
    setcmd.add_argument("--bilibili-chunk-model")
