# Media2MD v0.8.4 Strict Acceptance
...
## v0.8.3 exact catalog lifecycle additions
...
| 133 | v0.8.3 exact lifecycle requires live verification | FIXED-LIVE | Confirm installer repair, exact-catalog `AUTO_SYNC_SKIPPED`, and fresh explicit Full Sync bootstrap on the user project. |


## v0.8.4 staged exact rebuild additions
...
| 140 | v0.8.4 staged rebuild behavior requires live verification | FIXED-LIVE | Upgrade the StartupBell project, confirm `EXACT current=true`, then retry the existing rebuild and verify a 403 or bounded pause leaves the 1,159-item exact baseline active. |
