# Media2MD v0.8.3 Strict Acceptance
...
| 133 | v0.8.3 exact lifecycle requires live verification | FAIL-LIVE | Installer repair and exact-catalog `AUTO_SYNC_SKIPPED` passed live, but a fresh Full rebuild received a zero-page 403 and incorrectly downgraded the active exact catalog. Fixed by staged rebuild semantics in v0.8.4. |
